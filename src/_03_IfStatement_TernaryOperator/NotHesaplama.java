...
public class NotHesaplama {
    public static void main(String[] args) {
        ...
        todo  :  Koşul kısmı
 			...
 			80(80dahil)   ile 90 arasında ise  
...
System.out.println("Vize sinav soucunu giriniz:");
double vizenotu=scan.nextDouble();

System.out.println("Vize sınavı yüzdesini giriniz");
double vizyuzde=scan.nextDouble();

System.out.println("Final sinav soucunu giriniz:");
double finalnotu=scan.nextDouble();

System.out.println("Final sınavı yüzdesini giriniz");
double finyuzde=scan.nextDouble();
double ortalama=(vizenotu*vizyuzde/100)+(finalnotu*finyuzde/100);
